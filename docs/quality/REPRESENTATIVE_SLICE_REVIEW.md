...
Status: Built / Source-structure verified / Visual-device QA pending
...
## Required visual QA before component freeze
...
After approval, promote the component patterns to the 12-page static implementation. Astro remains deferred.
